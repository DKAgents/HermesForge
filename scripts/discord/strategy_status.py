...
STRATEGIES = [
    ...
    {"id": "STR-Y", "name": "ADX/DMI Directional", "status": "WATCH", "description": "DI cross with ADX>25 trend filter. WATCH: US-114 — OOS not significant, pending parameter sensitivity review.", "regimes": ["trending"], "edge": "Directional movement cross"},
