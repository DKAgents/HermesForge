...
> "If volume and open interest are both increasing, then the current price trend will probably continue in its present direction (either up or down). If, however, volume and open interest are declining, the action can be viewed as a warning that the current price trend may be nearing an end." — John J. Murphy
