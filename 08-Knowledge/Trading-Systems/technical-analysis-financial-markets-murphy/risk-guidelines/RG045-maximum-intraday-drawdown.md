...
> "This is the biggest drop, in dollar terms, from an equity peak to an equity trough." — John J. Murphy

> "I also differentiate between drawdowns from a standing start (where I am losing money from my own pocket) versus drawdowns from an equity peak (where I am giving back profits taken from the markets). I am usually more lenient with the latter." — John J. Murphy
