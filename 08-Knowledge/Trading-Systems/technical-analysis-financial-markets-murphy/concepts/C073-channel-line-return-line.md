...
> "Sometimes prices trend between two parallel lines—the basic trendline and the channel line." — John J. Murphy

> "If the next rally reaches and backs off from the channel line (at point 4), then a channel may exist. If prices then drop back to the original trendline (at point 5), then a channel probably does exist." — John J. Murphy
