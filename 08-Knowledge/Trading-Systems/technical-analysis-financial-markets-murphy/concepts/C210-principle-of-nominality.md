...
> "there seems to be a nominal set of harmonically related cycles that affect all markets" — John J. Murphy

> "The model begins with an 18 year cycle and proceeds to each successively lower cycle half its length. The only exception is the relationship between 54 and 18 months which is a third instead of a half." — John J. Murphy
