...
> "Count the number of columns in a bottom or topping pattern. That number of columns must then be multiplied by the value of the reversal or the number of boxes needed for a reversal." — John J. Murphy
