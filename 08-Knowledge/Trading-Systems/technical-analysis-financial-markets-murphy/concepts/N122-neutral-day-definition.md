...
> "A neutral day occurs when the longer term trader extends the range after the initial balance in one direction, then reverses and extends the range in the opposite direction. Neutral days indicate trader uncertainty and occur when the market probes or tests for price trend continuation or change." — John J. Murphy
