...
> "When a market is in a trend mode, a trend-following indicator like a moving average is needed to implement trades. A cycle mode would favor the use of oscillator-type indicators." — John J. Murphy
