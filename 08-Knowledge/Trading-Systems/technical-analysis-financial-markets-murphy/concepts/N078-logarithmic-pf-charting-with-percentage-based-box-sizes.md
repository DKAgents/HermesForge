...
> "A screening process that measures the volatility of a stock over the last 3 years determines the right percentage box size for each stock." — John J. Murphy
