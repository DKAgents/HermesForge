...
> "The persistence of existing trends over long periods of time, in many cases for years, is a compelling argument against the claims of Random Walk Theorists that prices are serially independent and that past price action has no effect on future price action." — John J. Murphy
