...
> "Because the markets are now so intertwined, the technical analyst has an enormous advantage. The technical tools described in this book can be applied to all markets, which greatly facilitates the application of intermarket analysis." — John J. Murphy
