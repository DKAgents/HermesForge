...
source_page_range: "~pp. 469–470 (est.)"
model_tier: T2
...
> "A price pattern with three prominent peaks, similar to the head and shoulders top, except that all three peaks occur at about the same level." — John J. Murphy

## Related Notes
- [[N022-triple-bottom-pattern|Triple Bottom Pattern]]
