...
source_page_range: "~pp. 192–246 (est.)"
model_tier: T2
...
> "A divergence between the oscillator and the price action when the oscillator is in an extreme position is usually an important warning." — John J. Murphy
