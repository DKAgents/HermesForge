...
> "The protective stop point can be raised to just below the latest o column in an uptrend and lowered to just over the latest x column in a downtrend. This use of a trailing stop allows the trader to stay with the position and protect accumulated profits at the same time." — John J. Murphy
