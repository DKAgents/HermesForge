...
|--------|----------|-------|
| Notes examined | 5 | 585 |
| Connections created | 0 | 240 |
| Review queue | 169 | 169 |
| Avg score | 4.6 | — |

## Graph Density Signals
- Total wikilinks in vault: ~4517
- Total notes: 2224
- Avg degree per note: 2.031
- Notes with links: 901 (40.6%)
- Orphan notes (no links): 1322 (59.4%)

## Weakly Connected Areas
- `campaigns/2026-09-aegis-rebuild` — 8 notes, avg degree 0.0
- `04-ForgeLoop` — 26 notes, avg degree 0.0
- `04-ForgeLoop/Maintenance` — 58 notes, avg degree 0.0
- `05-Research/Market-Intelligence` — 19 notes, avg degree 0.0
- `reports/campaigns/2026-09-aegis-rebuild` — 9 notes, avg degree 0.0

## Recent Discoveries (last run: 2026-09-12T05:25:04Z)
...
- Run 115: Created 2 connections from 5 notes. Avg score: 4.4.
