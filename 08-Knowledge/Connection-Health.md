...
|--------|----------|-------|
| Notes examined | 5 | 650 |
| Connections created | 0 | 250 |
| Review queue | 183 | 183 |
| Avg score | 4.3 | — |

## Graph Density Signals
- Total wikilinks in vault: ~4611
- Total notes: 2260
- Avg degree per note: 2.04
- Notes with links: 925 (41.0%)
- Orphan notes (no links): 1334 (59.0%)

## Weakly Connected Areas
- `campaigns/2026-09-aegis-rebuild` — 9 notes, avg degree 0.0
- `04-ForgeLoop` — 26 notes, avg degree 0.0
- `04-ForgeLoop/Maintenance` — 60 notes, avg degree 0.0
- `05-Research/Market-Intelligence` — 19 notes, avg degree 0.0
- `reports/campaigns/2026-09-aegis-rebuild` — 9 notes, avg degree 0.0

## Recent Discoveries (last run: 2026-09-14T09:50:51Z)
...
- Run 128: Created 1 connections from 5 notes. Avg score: 4.4.
